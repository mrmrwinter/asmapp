...
rule karyon_plots:
    ...
    shell:
        "python3 scripts/karyon_plots.py -fp {params[0]} --fasta {params[0]}{input[assembly]} --output_directory {params[0]}{params[out_pfx]} --output_name {params[out_name]} --vcf {params[0]}{input[vcf]} --pileup {params[0]}{input[mpileup]} --bam {params[0]}{input[bam]} --library {params[0]}{input[reads]}" # --configuration -wsize --max_scaf2plot --scafminsize --scafmaxsize --job_id"        # Identifier of the intermediate files generated by the different programs. If false, the program will assign a name consisting of a string of 6 random alphanumeric characters.')"
